...
| **QA Engineer** | Find the defects we planted in a running hall-booking system, then automate the regression suite | **[`roles/qa-engineer/REQUIREMENTS.md`](roles/qa-engineer/REQUIREMENTS.md)** |
